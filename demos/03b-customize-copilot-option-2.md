...
3. Run the hook with `bash .github/hooks/fix-broken-links/link-fix.sh ./demos/03b-customize-copilot-option-2.md` in your terminal. If you are using PowerShell, use the .ps1 script.
